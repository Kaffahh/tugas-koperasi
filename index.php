  ...
  * License: https://bootstrapmade.com/license/
  ...
  <body class="index-page">
    <header
      ...
      style="background-color: #677d6a"
    >
      <i class="header-toggle d-xl-none bi bi-list"></i>

      <div class="profile-img">
        <img
          src="assets/img/koperasi.png"
          alt=""
      ...
      >
        ...
        <h1 class="sitename">Koperasi Niggas</h1>
      </a>
        ...
        <ul>
          <li>
            <a href="#hero" class="active"
              ><i class="bi bi-house navicon"></i> Koperasi Sejahtera</a
            >
          </li>
          <li>
            <a href="#about"
              ><i class="bi bi-person navicon"></i> Kegiatan Koperasi</a
            >
          </li>
          <li>
            <a href="#resume"
              ><i class="bi bi-file-earmark-text navicon"></i> Data Pegawai</a
            >
          </li>
          <li>
            <a href="#portfolio"
              ><i class="bi bi-images navicon"></i> Gallery</a
            >
          </li>
          <li>
            <a href="#services"
      ...
      <section id="hero" class="hero section dark-background">
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
          ...
          <p>
            ...
            <span
              class="typed"
              data-typed-items="Narkoba, Kasus Korupsi, Orang Hitam, Paus Lahiran"
              >Korupsi</span
            ><span
      ...
      <section id="about" class="about section">
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
          <div class="row gy-4 justify-content-center">
            <div class="col-lg-4">
              <img src="assets/img/koperasi.png" class="img-fluid" alt="" />
            </div>
            <div class="col-lg-8 content">
              <h2>Koperasi Sejahtera</h2>
                ...
                <div class="col-lg-6">
                  <ul>
                    <li>
                      ...
                      <strong>Birthday:</strong> <span>100000 Abad SM</span>
                    </li>
                    <li>
                      <i class="bi bi-chevron-right"></i>
                      <strong>Website:</strong> <span>www.uban.com</span>
                    </li>
                    <li>
                      <i class="bi bi-chevron-right"></i>
                ...
                <div class="col-lg-6">
                  <ul>
                    <li>
                      ...
                      <span>300000000000000000000000000</span>
                    </li>
                    <li>
                      <i class="bi bi-chevron-right"></i>
            ...
            >
              ...
              >
                <div class="portfolio-content h-100">
                  <img
                    src="assets/img/portfolio/koperasi-1.jpeg"
                    class="img-fluid"
                    alt=""
                  />
              ...
              >
                <div class="portfolio-content h-100">
                  <img src="assets/img/portfolio/koperasi-4.jpeg
                  class="img-fluid" alt="" />
                  <div class="portfolio-info">
                    <h4>Product 1</h4>
                    <p>Lorem ipsum, dolor sit amet consectetur</p>
              ...
              >
                <div class="portfolio-content h-100">
                  <img
                    src="assets/img/portfolio/koperasi-3.jpeg"
                    class="img-fluid"
                    alt=""
                  />
                  <div class="portfolio-info">
              ...
              >
                <div class="portfolio-content h-100">
                  <img
                    src="assets/img/portfolio/koperasi-2.jpeg"
                    class="img-fluid"
                    alt=""
                  />
                  <div class="portfolio-info">
